...
while [ $nthread -lt $maxThread ]
	...
	while [ $k -lt $runPerThread ]
		...
		# vacation nice -20 taskset -c $affinity ./vacation -n4 -q60 -u90 -r1048576 -t4194304 -c$nthread > ris0.txt

		echo nice -20 taskset -c $affinity ./bayes -v32 -r4096 -n10 -p40 -i2 -e8 -s1 -t$nthread > ris0.txt
		nice -20 taskset -c $affinity ./bayes -v32 -r4096 -n10 -p40 -i2 -e8 -s1 -t$nthread > ris0.txt

		grep "Learn time" ris0.txt|sed -E -e "s/[a-zA-Z =:]*//g" > ris1.txt
