...
while [ $nthread -lt $maxThread ]
	...
	while [ $k -lt $runPerThread ]
		...
		echo nice -20 taskset -c $affinity ./vacation -n4 -q60 -u90 -r1048576 -t4194304 -p$nthread
		nice -20 taskset -c $affinity ./vacation -n4 -q60 -u90 -r1048576 -t4194304 -p$nthread > ris0.txt
