...
while [ $nthread -le $maxThread ] 
	...
	while [ $k -lt $runPerThread ]
		...
		nice -20 ./ssca2 -s20 -i1 -u1 -l3 -p3 -t$nthread >> results_analysis.txt
		k=$[$k+1]
	done
	nthread=$[$nthread+1]
done
...
while [ $nthread -le $maxThread ] 
        ...
        while [ $k -lt $runPerThread ]
                ...
                nice -20 ./ssca2 -s18 -i1 -u1 -l3 -p3 -t$nthread >> results_analysis.txt
                k=$[$k+1]
        done
        nthread=$[$nthread+1]
done
...
while [ $nthread -le $maxThread ] 
        ...
        while [ $k -lt $runPerThread ]
                ...
                nice -20 ./ssca2 -s19 -i1 -u1 -l9 -p9 -t$nthread >> results_analysis.txt
                k=$[$k+1]
        done
        nthread=$[$nthread+1]
done
...
while [ $nthread -le $maxThread ] 
        ...
        while [ $k -lt $runPerThread ]
                ...
                nice -20 ./ssca2 -s17 -i1 -u1 -l9 -p9 -t$nthread >> results_analysis.txt
                k=$[$k+1]
        done
        nthread=$[$nthread+1]
done
